    ...
    <div className='container'>
      ...
      />
          ...
          <div className='social-media'>
            <a href="https://www.linkedin.com/in/rohit-mhetre02/"><img src={Linkdian}/></a>
            <a href="https://www.instagram.com/mr_roya_002/"><img src={instagram}/></a>
            <a href="https://wa.me/9370949370?text=Hello%20Rohit"><img src={whatsapp}/></a>
          </div>
        </div>
